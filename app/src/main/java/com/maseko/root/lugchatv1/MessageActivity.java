...
import com.maseko.root.lugchatv1.Adapter.MessageAdapter;
import com.maseko.root.lugchatv1.Api.APIService;
import com.maseko.root.lugchatv1.Model.Chat;
import com.maseko.root.lugchatv1.Model.User;
import com.maseko.root.lugchatv1.Notification.Client;
import com.maseko.root.lugchatv1.Notification.Data;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.video_call:
                Toast.makeText(MessageActivity.this, "Fitur not available now!", Toast.LENGTH_SHORT).show();
                return true;
